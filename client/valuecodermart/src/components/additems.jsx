...
export default function CustomizedSteppers(props) {
    ...
    const [productName] = React.useState(props.productName)
    ...
    function getStepContent(step) {
        switch (step) {
            ...
            case 1:
                return <Items
                    giveItemList={getItemList} itemList={itemList}
                />;
            case 2:
                return <Saveproduct
                    productName={productName} itemList={itemList} quantity={getQuantity} helper={changingHelper}
                />;
            default:
                return "unknown step";
        }
    ...
    if (activeStep === steps.length && counter === true) {

        Axios.post('/edititems', {
            productId: productId,
